...
<body style="background-color:#d9d9d9;">
  ...
  <div style="padding-top:150px;" class="container mb-3">
    <div class="rounded" style="background-color:white; padding:20px;">
        <h3 class="m-3"> <b>Community & Collaboration</b> </h3>
        ...
        <p class="p-2 mt-3" style="color: black; font-size:13px;">
        ...
        <p class="p-2 mt-3" style="color: black; font-size:13px;">
            We can help, we want to help, and we will help, please <a href="https://opensource.org/contact" target="blank"> ask us how.</a>
        </p>

        <h3 align="center" class="mt-3"> <b>Community Support</b> </h3>

        <p class="p-2 mt-3" style="color:black; font-size:13px; text-align:center;">
            <b>Questions, answers, mailing lists, live chat and more:</b> 
                Whether you're an open source advocate who wants to spread the word about the benefits of open source, a software developer looking for tips or tools, an entrepreneur with a start-up or business leader transforming your company, we have resources to help.
        </p>
